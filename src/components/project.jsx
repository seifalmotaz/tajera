...
export default function ProjectsGallery() {
  ...
  const projects = [
    ...
    {
      id: 28,
      title: t("projectstilte.28"),
      category: t("categories.informational"),
      image: "/assets/images/mapc.png",
    },
    {
      id: 29,
      title: t("projectstilte.29"),
      category: t("categories.informational"),
  ...
  const projectsPerPage = 8; // Show 8 projects per page
  ...
  const handlePageChange = (page) => {
    setCurrentPage(page);
    setTimeout(scrollToProjects, 100); // Small delay to ensure state update
  };
  ...
  return (
    <section className="md:py-16 py-4 max-w-[1200px] m-auto px-4 text-center" data-projects-section>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-semibold transition-all duration-200 ${
              currentPage === 1
                ...
                : "bg-[var(--color-logo-magenta)] text-white hover:bg-opacity-80"
            }`}
          >
            ← Previous
          </button>
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={`px-3 py-2 rounded-lg font-semibold transition-all duration-200 ${
                  currentPage === page
                    ? "bg-[var(--color-logo-magenta)] text-white"
